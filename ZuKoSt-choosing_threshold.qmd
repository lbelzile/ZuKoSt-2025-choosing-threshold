...
Many heavy-tailed distributions fall within the @Hall.Welsh:1985 class have $A(t) = \beta t^\rho$ for $\beta \neq 0$ with $\rho < 0.$

The asymptotic mean squared error of Hill's estimator is $$\mathsf{AMSE}(H_{n,n_u}) = \xi^2/n_u + A^2(n/n_u)/(1-\rho)^2,$$ which is minimized when
\begin{align}
